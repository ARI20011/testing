                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Total kategori</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div><?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM kategori")); ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                 Total Buku</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div><?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM buku")); ?>
